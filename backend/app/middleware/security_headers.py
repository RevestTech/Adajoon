    ...
    async def dispatch(self, request: Request, call_next):
        ...
        if settings.env == "production":
            ...
            csp_directives = [
                ...
                "connect-src 'self' https://iptv-org.github.io https://de1.api.radio-browser.info https://raw.githubusercontent.com https://accounts.google.com https://appleid.apple.com https://fonts.googleapis.com https://fonts.gstatic.com https://imasdk.googleapis.com https://www.gstatic.com https://demotiles.maplibre.org https://*.maplibre.org https://tile.openstreetmap.org",
